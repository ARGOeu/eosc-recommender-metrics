...
@doc('The Shannon Entropy of the recommendations according to book https://link.springer.com/10.1007/978-1-4939-7131-2_110158. The entropy is 0 when a single item is always chosen or recommended, and log n when n items are chosen or recommended equally often.')
def shannon_entropy(object, anonymous=False):
    """
